...
import 'package:bloc_custom_firebase/ui/component.dart';
              ...
              child: Center(
                child: BlocConsumer<OnboardCubit, OnboardState>(
                  builder: (context, state) {
                    if (state is OnboardInitial || state is OnboardError) {
                      return Container(
                  ...
                  listener: (context, state) {
                    ...
                    } else if (state is OnboardError) showToast(state.msg);
                  },
                ),
              ),
            ),
